...
const OnboardingManager = {
  ...
  currentStep: 0,
  totalSteps: 5,  // Welcome, LLM Config, Persona Selection, Google Integration, Completion
      ...
      case 3:
        ...
        content.innerHTML = `
          ...
          <div class="wizard-content">
            ...
            <h2 class="wizard-title">Connect Google Calendar</h2>
            <p class="wizard-description">
              Sync your tasks and calendar with MinouChat. Your AI assistant can help you manage events
              and remind you of important dates.
            </p>
            <div style="margin-top: var(--space-6); display: flex; flex-direction: column; gap: var(--space-3); align-items: center;">
              <button class="btn btn-primary" onclick="OnboardingManager.connectGoogle()" style="display: flex; align-items: center; gap: var(--space-2); padding: var(--space-3) var(--space-5);">
              ...
              <button class="btn btn-ghost text-muted" onclick="OnboardingManager.nextStep()" style="font-size: var(--text-sm);">
                Skip for now
              </button>
            </div>
            <p class="text-sm text-muted" style="margin-top: var(--space-4);">
              You can always connect later from Settings → Google Integration
            </p>
          </div>
        `;
        footer.innerHTML = `
  ...
  /**
   * Connect Google Account - redirects to Settings page with Google Integration section
   */
  connectGoogle() {
    // Mark onboarding as complete before redirecting
    this.markComplete();
    // Redirect to settings page with hash to scroll to Google Integration section
    window.location.href = '/settings#google-integration';
  },
